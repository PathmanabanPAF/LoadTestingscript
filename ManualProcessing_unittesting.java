...
public class ManualProcessing_unittesting {
...
public void ManualProcessing_start(WebDriver driver) throws InterruptedException
{
	try {
		...
		Select d4=new Select(utype3);
		d4.selectByValue("ManualProcessing_CPRWB");
...
public void ManualProcessing_validate(WebDriver driver) throws InterruptedException
{
	try {
		...
		Thread.sleep(4000);
		WebElement list=driver.findElement(By.id("actionContainer"));
		list.findElement(By.name("AccessGroup")).click();
		Thread.sleep(4000);
